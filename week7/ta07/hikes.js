...
export default class Hikes {
  ...
  showOneHike(hikeName) {
    ...
    this.comment.renderOneHike(hikeName);

    //input comments
    document.getElementById('btn').addEventListener('touchend', () => {
      this.comment.addComment(hikeName, document.getElementById("newComment").value);
...
function renderOneHikeFull(hike) {
  ...
  item.innerHTML = ` 
        ...
        <div id="oneHikeCommnets"></div>
        <input type="text" id="newComment" placeholder="Add Comment">
